...
void first_pass(const char *src) {
    ...
    if (!input_pre_assembled) {
        ...
        while (fgets(line, MAX_LINE_LEN, input_pre_assembled) != NULL) {
            ...
            field = split_line_to_fields(line_copy, 0, " \t\n:"); /* Split the line into fields */
            if (field && is_symbol(field)) { /* Check if the field is a symbol */
            ...
            if (field != NULL) {
                ...
                if (is_storage(field)) {
                    ...
                    if (is_symbol_flag) {
                        ...
                        strcpy(symbol_name, split_line_to_fields(line, 0, " \t\n:"));
                    ...
                    /* 7. Encode the data values in memory, update DC and go to step 2 */
                    /* TODO: Implement encoding of data values */
                    /* For now, we'll just increment DC by a placeholder amount */
                    DC += 4; /* Placeholder, replace with actual data encoding logic */
                ...
                /* 8. Check if line contains .extern or .entry directive */
                    ...
                    if (strcmp(field, ".entry") != 0) {
                        ...
                        if (strcmp(field, ".extern") == 0) {
                            ...
                            extern_symbol = split_line_to_fields(NULL, 0, " \t\n");
